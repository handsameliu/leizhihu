...
router.get('/findBySubject/:id',userController.findBySubject);					/*根据类型查询帖子*/
router.get('/findArticleById/:id',articleController.findArticleById);		/*根据id查询帖子及相关内容*/
router.post('/saveArticle',userController.saveArticle);									/*添加帖子*/
router.post('/saveComment',userController.saveComment);									/*添加评论*/
